...
flash train examples/sudoku-sft-grpo/train_grpo.toml --dry-run
flash train examples/sudoku-sft-grpo/train_grpo.toml --cost
flash train examples/sudoku-sft-grpo/train_grpo.toml --background
```
